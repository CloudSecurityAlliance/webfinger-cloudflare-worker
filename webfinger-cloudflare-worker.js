// So you want to use webfinger to map every user at your site so they use their email 
// as a Mastodon search term to redirect to whatever Mastodon ID they're actually using?
...
// and populate the redirectMap data

// This has obvious scale issues (a cloudflare worker can only be 1MB in size after compression), but it should work up to a few hundred 
// (thousands?) users.
